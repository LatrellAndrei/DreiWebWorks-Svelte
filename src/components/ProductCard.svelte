<script>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-14 lg:gap-20 relative text-base">
        ...
        <h4 class ="text-2xl sm:text-3xl md:text-4xl max-w-[1000px] w-full font-medium relative pr-10 after:absolute after:top-full after:left-0
        after:w-1/5 after:h-1.5 after:mt-1 after:bg-slate-900 ">
        <slot/>
        </h4>
    <!--Product features with description with the list-->
    ...
    <div class="flex items-center">
        <button class="specialBtnDark mr-auto font-semibold">
            <p>Chat us Today &rarr;</p>
        </button>
    </div>
</div>
<!--This code is for showing the three images in the right side-->
<div class={"flex flex-col dropShadow overflow-hidden rounded-b-lg" + (index % 2 === 1 ? "md:order-2" : " ")}>
